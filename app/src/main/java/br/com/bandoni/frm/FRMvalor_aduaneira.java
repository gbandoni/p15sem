...
import br.com.bandoni.dao.implementation.ValorAduaneiraDAOImpl;
import br.com.bandoni.dao.tables.J34SiscomexValorAduaneira;

import br.com.bandoni.siscomexhelper.R;

public class FRMvalor_aduaneira extends AppCompatActivity 
{
    private J34SiscomexValorAduaneira table;
    private ValorAduaneiraDAOImpl dao;
    private int action;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (action != ActionReference.ACTION_INCLUDE)
        {
            ...
            {
                Toast.makeText(FRMvalor_aduaneira.this, "Exceção: "+e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
        else
        {
          table = new J34SiscomexValorAduaneira();
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_detail_valor_aduaneira, menu);
        return true;
    }
