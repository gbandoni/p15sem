...
public class BRWorigem_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_origem_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_origem_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_origem_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMorigem_di.class);
