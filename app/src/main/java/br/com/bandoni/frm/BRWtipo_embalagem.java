...
public class BRWtipo_embalagem extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipo_embalagem";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipo_embalagem);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipo_embalagem, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipo_embalagem.class);
