...
public class BRWcompensacao_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_compensacao_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_compensacao_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_compensacao_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMcompensacao_di.class);
