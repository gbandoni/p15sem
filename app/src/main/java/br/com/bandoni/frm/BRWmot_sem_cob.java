...
public class BRWmot_sem_cob extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_mot_sem_cob";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_mot_sem_cob);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_mot_sem_cob, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmot_sem_cob.class);
