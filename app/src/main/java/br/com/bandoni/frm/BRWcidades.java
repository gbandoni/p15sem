...
public class BRWcidades extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_cidades";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_cidades);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_cidades, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMcidades.class);
