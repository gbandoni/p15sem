...
public class BRWmoedas extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_moedas";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_moedas);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_moedas, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmoedas.class);
