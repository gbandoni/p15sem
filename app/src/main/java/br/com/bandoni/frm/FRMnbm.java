...
import br.com.bandoni.dao.implementation.NbmDAOImpl;
...
public class FRMnbm extends AppCompatActivity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (action != ActionReference.ACTION_INCLUDE)
        {
            ...
            {
                Toast.makeText(FRMnbm.this, "Exceção: "+e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
        else
        {
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_detail_nbm, menu);
        return true;
    }
