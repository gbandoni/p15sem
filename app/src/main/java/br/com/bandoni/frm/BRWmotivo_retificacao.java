...
public class BRWmotivo_retificacao extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_motivo_retificacao";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_motivo_retificacao);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_motivo_retificacao, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmotivo_retificacao.class);
