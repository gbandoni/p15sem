...
public class BRWviatransporte extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_viatransporte";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_viatransporte);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_viatransporte, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMviatransporte.class);
