...
public class BRWinfo_mercosul_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_info_mercosul_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_info_mercosul_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_info_mercosul_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMinfo_mercosul_di.class);
