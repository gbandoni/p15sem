...
public class BRWtipo_recipiente extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipo_recipiente";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipo_recipiente);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipo_recipiente, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipo_recipiente.class);
