...
public class BRWdocumentos_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_documentos_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_documentos_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_documentos_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMdocumentos_di.class);
