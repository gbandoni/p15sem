...
public class BRWtributo_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tributo_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tributo_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tributo_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtributo_adi.class);
