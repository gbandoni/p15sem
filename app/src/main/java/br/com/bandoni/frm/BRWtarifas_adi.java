...
public class BRWtarifas_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tarifas_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tarifas_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tarifas_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtarifas_adi.class);
