...
public class BRWimpostos_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_impostos_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_impostos_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_impostos_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMimpostos_di.class);
