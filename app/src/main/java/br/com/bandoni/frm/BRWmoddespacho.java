...
public class BRWmoddespacho extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_moddespacho";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_moddespacho);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_moddespacho, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmoddespacho.class);
