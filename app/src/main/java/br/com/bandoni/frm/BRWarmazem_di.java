...
public class BRWarmazem_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_armazem_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_armazem_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_armazem_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMarmazem_di.class);
