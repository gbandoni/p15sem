...
public class BRWacrescimos extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_acrescimos";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_acrescimos);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_acrescimos, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMacrescimos.class);
