...
public class BRWrecintoalfandegado extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_recintoalfandegado";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_recintoalfandegado);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_recintoalfandegado, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMrecintoalfandegado.class);
