...
public class BRWdi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMdi.class);
