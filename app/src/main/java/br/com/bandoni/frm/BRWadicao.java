...
public class BRWadicao extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_adicao";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_adicao);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_adicao, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMadicao.class);
