...
public class BRWacrescimo_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_acrescimo_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_acrescimo_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_acrescimo_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMacrescimo_adi.class);
