...
public class BRWmot_adm_temp extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_mot_adm_temp";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_mot_adm_temp);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_mot_adm_temp, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmot_adm_temp.class);
