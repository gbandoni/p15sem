...
public class BRWtipo_importador extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipo_importador";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipo_importador);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipo_importador, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipo_importador.class);
