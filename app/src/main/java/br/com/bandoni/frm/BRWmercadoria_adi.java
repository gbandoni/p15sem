...
public class BRWmercadoria_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_mercadoria_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_mercadoria_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_mercadoria_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmercadoria_adi.class);
