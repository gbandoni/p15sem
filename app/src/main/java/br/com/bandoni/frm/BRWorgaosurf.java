...
public class BRWorgaosurf extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_orgaosurf";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_orgaosurf);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_orgaosurf, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMorgaosurf.class);
