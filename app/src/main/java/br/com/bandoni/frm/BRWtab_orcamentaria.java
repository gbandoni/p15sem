...
public class BRWtab_orcamentaria extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tab_orcamentaria";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tab_orcamentaria);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tab_orcamentaria, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtab_orcamentaria.class);
