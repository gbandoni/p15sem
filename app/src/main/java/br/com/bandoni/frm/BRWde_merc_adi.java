...
public class BRWde_merc_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_de_merc_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_de_merc_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_de_merc_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMde_merc_adi.class);
