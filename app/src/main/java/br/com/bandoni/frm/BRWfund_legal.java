...
public class BRWfund_legal extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_fund_legal";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_fund_legal);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_fund_legal, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMfund_legal.class);
