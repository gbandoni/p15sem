...
public class BRWlocalidadeembarque extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_localidadeembarque";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_localidadeembarque);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_localidadeembarque, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMlocalidadeembarque.class);
