...
public class BRWnaladi_ncca extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_naladi_ncca";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_naladi_ncca);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_naladi_ncca, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMnaladi_ncca.class);
