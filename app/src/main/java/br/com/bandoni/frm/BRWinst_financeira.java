...
public class BRWinst_financeira extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_inst_financeira";
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_inst_financeira, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMinst_financeira.class);
