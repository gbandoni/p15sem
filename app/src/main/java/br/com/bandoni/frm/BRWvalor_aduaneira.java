...
public class BRWvalor_aduaneira extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_valor_aduaneira";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_valor_aduaneira);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_valor_aduaneira, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMvalor_aduaneira.class);
