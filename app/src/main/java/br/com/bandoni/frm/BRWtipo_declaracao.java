...
public class BRWtipo_declaracao extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipo_declaracao";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipo_declaracao);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipo_declaracao, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipo_declaracao.class);
