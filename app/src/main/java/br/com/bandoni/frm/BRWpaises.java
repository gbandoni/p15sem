...
public class BRWpaises extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_paises";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_paises);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_paises, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMpaises.class);
