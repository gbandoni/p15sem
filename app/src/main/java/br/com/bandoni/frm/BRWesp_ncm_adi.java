...
public class BRWesp_ncm_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_esp_ncm_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_esp_ncm_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_esp_ncm_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMesp_ncm_adi.class);
