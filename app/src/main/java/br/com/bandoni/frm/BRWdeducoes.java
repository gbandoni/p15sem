...
public class BRWdeducoes extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_deducoes";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_deducoes);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_deducoes, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMdeducoes.class);
