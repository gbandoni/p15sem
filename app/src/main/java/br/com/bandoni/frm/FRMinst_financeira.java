...
import br.com.bandoni.dao.implementation.InstFinanceiraDAOImpl;
...
public class FRMinst_financeira extends AppCompatActivity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (action != ActionReference.ACTION_INCLUDE)
        {
            ...
            {
                Toast.makeText(FRMinst_financeira.this, "Exceção: "+e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
        else
        {
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_detail_inst_financeira, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_save)
        {
            if (action != ActionReference.ACTION_VIEW)
            {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(FRMinst_financeira.this);
