...
import br.com.bandoni.dao.implementation.RegimeTributDAOImpl;
...
public class FRMregime_tribut extends AppCompatActivity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (action != ActionReference.ACTION_INCLUDE)
        {
            ...
            {
                Toast.makeText(FRMregime_tribut.this, "Exceção: "+e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
        else
        {
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_detail_regime_tribut, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_save)
        {
            if (action != ActionReference.ACTION_VIEW)
            {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(FRMregime_tribut.this);
