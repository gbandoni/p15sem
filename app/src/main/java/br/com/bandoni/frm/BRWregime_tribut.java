...
public class BRWregime_tribut extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_regime_tribut";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_regime_tribut);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_regime_tribut, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMregime_tribut.class);
