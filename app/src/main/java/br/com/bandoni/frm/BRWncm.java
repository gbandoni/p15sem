...
public class BRWncm extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_ncm";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_ncm);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_ncm, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMncm.class);
