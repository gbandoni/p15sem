...
public class BRWtipo_documento extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipo_documento";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipo_documento);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipo_documento, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipo_documento.class);
