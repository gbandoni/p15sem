...
import br.com.bandoni.dao.implementation.NcmDAOImpl;
import br.com.bandoni.dao.tables.J34SiscomexNcm;

import br.com.bandoni.siscomexhelper.R;

public class FRMncm extends AppCompatActivity 
{
    private J34SiscomexNcm table = new J34SiscomexNcm();
    private NcmDAOImpl dao = new NcmDAOImpl(this);
    private int action;
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_detail_ncm, menu);
        return true;
    }
