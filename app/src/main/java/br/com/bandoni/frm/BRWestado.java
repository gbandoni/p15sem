...
public class BRWestado extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_estado";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_estado);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_estado, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMestado.class);
