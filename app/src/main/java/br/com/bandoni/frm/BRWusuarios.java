...
public class BRWusuarios extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_usuarios";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_usuarios);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_usuarios, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMusuarios.class);
