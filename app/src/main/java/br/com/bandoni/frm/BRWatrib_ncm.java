...
public class BRWatrib_ncm extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_atrib_ncm";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_atrib_ncm);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_atrib_ncm, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMatrib_ncm.class);
