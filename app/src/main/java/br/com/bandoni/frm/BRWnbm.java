...
public class BRWnbm extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_nbm";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_nbm);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_nbm, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMnbm.class);
