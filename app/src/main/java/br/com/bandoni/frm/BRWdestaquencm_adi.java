...
public class BRWdestaquencm_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_destaquencm_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_destaquencm_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_destaquencm_adi, menu);
        return true;
    }
