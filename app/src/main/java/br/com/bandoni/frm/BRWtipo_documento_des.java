...
public class BRWtipo_documento_des extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipo_documento_des";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipo_documento_des);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipo_documento_des, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipo_documento_des.class);
