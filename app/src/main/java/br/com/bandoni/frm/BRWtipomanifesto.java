...
public class BRWtipomanifesto extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_tipomanifesto";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_tipomanifesto);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_tipomanifesto, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMtipomanifesto.class);
