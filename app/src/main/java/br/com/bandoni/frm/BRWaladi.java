...
public class BRWaladi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_aladi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_aladi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_aladi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMaladi.class);
