...
public class BRWmotivotransmissao extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_motivotransmissao";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_motivotransmissao);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_motivotransmissao, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMmotivotransmissao.class);
