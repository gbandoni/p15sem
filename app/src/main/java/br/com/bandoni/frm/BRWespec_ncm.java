...
public class BRWespec_ncm extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_espec_ncm";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_espec_ncm);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_espec_ncm, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMespec_ncm.class);
