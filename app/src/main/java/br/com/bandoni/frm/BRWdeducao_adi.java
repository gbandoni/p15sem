...
public class BRWdeducao_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_deducao_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_deducao_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_deducao_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMdeducao_adi.class);
