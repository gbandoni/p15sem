...
public class BRWveiculos extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_veiculos";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_veiculos);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_veiculos, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMveiculos.class);
