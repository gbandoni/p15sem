...
import br.com.bandoni.dao.implementation.TipoDocumentoDesDAOImpl;
...
public class FRMtipo_documento_des extends AppCompatActivity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (action != ActionReference.ACTION_INCLUDE)
        {
            ...
            {
                Toast.makeText(FRMtipo_documento_des.this, "Exceção: "+e.getMessage(), Toast.LENGTH_LONG).show();
            }
        }
        else
        {
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        getMenuInflater().inflate(R.menu.menu_detail_tipo_documento_des, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_save)
        {
            if (action != ActionReference.ACTION_VIEW)
            {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(FRMtipo_documento_des.this);
