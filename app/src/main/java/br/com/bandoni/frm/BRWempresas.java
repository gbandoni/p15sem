...
public class BRWempresas extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_empresas";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_empresas);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_empresas, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMempresas.class);
