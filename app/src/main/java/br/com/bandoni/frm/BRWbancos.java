...
public class BRWbancos extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_bancos";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_bancos);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_bancos, menu);
        return true;
    }
