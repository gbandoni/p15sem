...
public class BRWnaladi_sh extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_naladi_sh";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_naladi_sh);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_naladi_sh, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMnaladi_sh.class);
