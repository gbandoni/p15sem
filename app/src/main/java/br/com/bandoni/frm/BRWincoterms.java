...
public class BRWincoterms extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_incoterms";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_incoterms);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_incoterms, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMincoterms.class);
