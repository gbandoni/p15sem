...
public class BRWprocesso_di extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_processo_di";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_processo_di);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_processo_di, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMprocesso_di.class);
