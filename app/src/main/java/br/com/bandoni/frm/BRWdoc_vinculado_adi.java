...
public class BRWdoc_vinculado_adi extends AppCompatActivity
{

    private final String tablename = "j34_siscomex_doc_vinculado_adi";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_browse_doc_vinculado_adi);
    ...
    {
        getMenuInflater().inflate(R.menu.menu_browse_doc_vinculado_adi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent i = new Intent(this,FRMdoc_vinculado_adi.class);
